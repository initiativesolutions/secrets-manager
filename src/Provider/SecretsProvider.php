...
class SecretsProvider
{
     ...
     */
    public function decryptByFiles(string $secretKeyPath, string $secretsTokensPath, string $algo = 'aes256'): array
    {
    ...
    public function decryptByTokens(string $secretKey, array $secretsTokens, string $algo = 'aes256'): array
    {
